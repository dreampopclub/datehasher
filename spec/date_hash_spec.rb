require 'datehasher/date_hash'

RSpec.describe DateHasher::DateHash do
  # describe 'test' do
  #   it 'returns true' do
  #     expect(described_class.new().test).to be true
  #   end
  # end
  ...
  describe '#add' do
    context 'when no date arg is passed' do
      it 'Adds today' do
        dh = DateHasher.new({})
        expect(dh.add).to eq({ '2023' => { '8' => { '25' => true }}})
      end
    end
  end
end
